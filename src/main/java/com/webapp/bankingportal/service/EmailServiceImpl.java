...
public class EmailServiceImpl implements EmailService {
    ...
    public String getLoginEmailTemplate(String name, String loginTime, String loginLocation) {
        return "<div style=\"font-family: Helvetica, Arial, sans-serif; min-width: 320px; max-width: 1000px; margin: 0 auto; overflow: auto; line-height: 2; background-color: #f1f1f1; padding: 20px;\">"
                ...
                + "<a href=\"https://abc.netlify.app/\" style=\"text-decoration: none;\">"
                + "<img src=\"https://abc.netlify.app/assets/onestoplogo.jpg\" alt=\"abc\" style=\"height: 50px; margin-bottom: 10px;\">"
                + "</a>" + "<h1 style=\"font-size: 1.8em; color: #3f51b5; margin: 10px 0;\">abc</h1>" + "</div>"
                ...
                + "<p style=\"font-size: 1em; color: #555;\">Regards,<br />The abc Team</p>" + "</div>"
                + "<hr style=\"border: none; border-top: 1px solid #ddd; margin: 20px 0;\" />"
                + "<div style=\"text-align: center; font-size: 0.9em; color: #888;\">"
                + "<p>Need help? Contact our support team:</p>"
                + "<p>Email: <a href=\"mailto:sumitbashetwar@google.com\" style=\"color: #3f51b5; text-decoration: none;\">sumitbashetwar@google.com</a></p>"
                + "</div>" + "</div>" + "</div>" + "</div>";
    }
    ...
    public String getOtpLoginEmailTemplate(String name, String accountNumber, String otp) {
        return "<div style=\"font-family: Helvetica, Arial, sans-serif; min-width: 320px; max-width: 1000px; margin: 0 auto; overflow: auto; line-height: 2; background-color: #f1f1f1; padding: 20px;\">"
                ...
                + "<p style=\"font-size: 1em; color: #333;\">Thank you for choosing abc. Use the following OTP to complete your login procedures. The OTP is valid for "
                ...
                + otp + "</h2>" + "<p style=\"font-size: 1em; color: #555;\">Regards,<br />The abc Team</p>"
